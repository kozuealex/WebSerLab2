...
//        throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Id " + id + " not found.");
    ...
    public @ResponseBody MonkeyDto replace(@RequestBody MonkeyDto monkeyDto, @PathVariable Integer id) {
        return service.replace(id, monkeyDto);
    }

    @PatchMapping("/animals/{id}")
    public @ResponseBody MonkeyDto update(@RequestBody MonkeyDto monkeyDto, @PathVariable Integer id) {
